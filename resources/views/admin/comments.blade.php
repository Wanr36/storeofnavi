...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        ...
        <ul class="nav navbar-top-links navbar-left menu-str" id="main-menu">
            ...
            <li>
                <a class="active-menu" href="/adminzone/comments"><i class="fa fa-comment-o"></i> Коментарии</a>
            </li>
            <li>
    ...
    <div id="page-wrapper">
        <div class="header">
            <h1 class="page-header">
                Поьзователь <small>Страница кометариев</small>
            </h1>
            <ol class="breadcrumb">
                                        ...
                                        <table class="table table-hover table-reviews">
                                            ...
                                            @foreach($comments as $comment)
                                                <tr>
                                                    ...
                                                    <th>{!! $comment->textComments !!}</th>
                                                    <th>{!! $comment->addUserComments !!}</th>
                                                    <th>
                                                        @if ($comment->statusComments == 0)
                                                            Скрыто
                                                        @else
                                                            Отоброжено
                                                        @endif
                                                    </th>
                                                    <th>{!! date("d.m.Y",strtotime($comment->created_at)) !!}</th>
                                                    <th>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li class="{!! $comment->id !!} delite_question"><a href="#">Ответить</a></li>
                                                                <li class="{!! $comment->id !!} delite_question"><a href="#">Удалить вопрос-ответ</a></li>
                                                            </ul>
                                                        </div>
                                                    </th>
                                                </tr>
