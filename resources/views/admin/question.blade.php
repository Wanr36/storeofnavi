...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        ...
        <ul class="nav navbar-top-links navbar-left menu-str" id="main-menu">
            ...
            <li>
                <a class="active-menu" href="/adminzone/question"><i class="fa fa-question"></i> Вопрос-ответ</a>
            </li>
        </ul>
    ...
    <div id="page-wrapper">
        <div class="header">
            <h1 class="page-header">
                Поьзователь <small>Страница вопросов</small>
            </h1>
            <ol class="breadcrumb">
                                        ...
                                        <table class="table table-hover table-reviews">
                                            ...
                                            @foreach($questionAnswers as $questionAnswer)
                                                <tr>
                                                    ...
                                                    <th>{!! $questionAnswer->textQuestionAnswer !!}</th>
                                                    <th>{!! $questionAnswer->addUserQuestionAnswer !!}</th>
                                                    <th>{!! $questionAnswer->addEmailQuestionAnswer !!}</th>
                                                    <th>
                                                        @if($questionAnswer->statusQuestionAnswer == 0)
                                                            {{ "Скрыт" }}
                                                        @else
                                                            {{ "Опубликован" }}
                                                        @endif
                                                    <th>{!! date("d.m.Y",strtotime($questionAnswer->created_at)) !!}</th>
                                                    <th>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li class="{!! $questionAnswer->id !!} update_question"><a href="#">Редактировать вопрос-ответ</a></li>
                                                                <li role="separator" class="divider"></li>
                                                                <li class="{!! $questionAnswer->id !!} delite_question"><a href="#">Удалить вопрос-ответ</a></li>
...
<div class="modal fade" id="window_modal_form" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title window_modal_form_title"> </h4>
            </div>
            <div class="modal-body window_modal_form_body">
            </div>
            <div class="modal-footer window_modal_form_footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Закрыть окно</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<script src="{!! asset('/adminstyle/js/nicEdit.js') !!}"></script>
